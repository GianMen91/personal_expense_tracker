...
import 'package:personal_expense_tracker/widgets/year_selector.dart'; // Make sure the path is correct

void main() {
  testWidgets('YearSelector widget test', (WidgetTester tester) async {
    final selectedDate = DateTime(2025);

    // Create a mock ExpensesStatBloc to inject into the widget tree
    ...
    // Simulate pressing the "previous year" button
    await tester.tap(find.byKey(Key('previous_year_icon')));
